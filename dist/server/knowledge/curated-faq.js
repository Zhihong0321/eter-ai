...
const REPRESENTED_BRANDS = [
    { name: 'Eternalgy', detail: 'In-house solar PV delivery' },
    { name: 'JinkoSolar', detail: 'Panel warranty and performance' },
    { name: 'SAJ', detail: 'Inverter supply and support' },
...
const CERTIFICATIONS = [
    { name: 'CIDB G3', detail: 'Registered contractor' },
    { name: 'SEDA RPVSP', detail: 'Solar PV Service Provider' },
    { name: 'SEDA Investor', detail: 'Solar PV Investor' },
    { name: 'MyHIJAU', detail: 'SAJ certification MyHS00025/25' },
...
function renderLogoTiles(items) {
    return items
        .map((item) => [
        '<div class="ans-premium__logo-tile">',
