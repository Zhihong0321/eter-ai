 ...
 */
export async function getCacheEntries(): Promise<CacheSummary[]> {
  await ensureLoaded();
 ...
 */
export async function regenerateEntry(question: string): Promise<void> {
  await ensureLoaded();
 ...
 */
export async function markStaleByTopic(topic: string): Promise<void> {
  await ensureLoaded();
